...
- Add the implementation of the parsing in a specific function in io.ReadVar, or in an external file, like [ParseVectorReal.scala](/src/main/scala/io/ParseVectorReal.scala)
