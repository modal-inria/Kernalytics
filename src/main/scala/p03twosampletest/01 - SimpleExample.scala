...
object SimpleExample {
  def main {
    ...
    val gram = Gram.generate(data, (x: Double, y: Double) => Kernel.R.gaussian(x, y, kernelSd)) // computation of the complete gram matrix, with data from the two distributions as it will be used in 
