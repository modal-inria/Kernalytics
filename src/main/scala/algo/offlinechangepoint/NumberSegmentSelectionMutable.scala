...
object NumberSegmentSelectionMutable {
  /**
   ...
   */
  def optimalNumberSegments(resFromSegmentation: DenseMatrix[SegmentationMutable.SegCost], nObs: Index): optimalNumberSegmentsReturn = {
